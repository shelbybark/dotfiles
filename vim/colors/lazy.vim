" Vim color file
" Converted from Textmate theme LAZY copy using Coloration v0.2.4 (http://github.com/sickill/coloration)
...
let g:colors_name = "LAZY copy"

hi Cursor  guifg=NONE guibg=#7c7c7c gui=NONE
hi Visual  guifg=NONE guibg=#e6ff8f gui=NONE
...
hi PmenuSel  guifg=NONE guibg=#e6ff8f gui=NONE
